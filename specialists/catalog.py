...
SPECIALISTS: tuple[SpecialistDefinition, ...] = (
    SpecialistDefinition(
        ...
        implementation_files=(
            "specialists/adapters/input_adapter.py",
            "specialists/adapters/input_adapter_preview.py",
            "specialists/adapters/telegram_adapter.py",
            "specialists/adapters/telegram_adapter_preview.py",
            "specialists/adapters/telegram_response.py",
            "specialists/adapters/telegram_update_probe.py",
            "specialists/adapters/markitdown_adapter.py",
            "specialists/adapters/markitdown_batch.py",
